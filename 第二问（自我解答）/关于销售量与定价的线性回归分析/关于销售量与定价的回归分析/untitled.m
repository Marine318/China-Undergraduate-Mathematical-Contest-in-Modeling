% 定义文件路径和数据集名称
file_paths = {"C:\Users\边锋BF\Desktop\关于销售量与定价的回归分析\销售定价.xlsx" ,"C:\Users\边锋BF\Desktop\关于销售量与定价的回归分析\销售量.xlsx", };
dataset_names = {'花菜类', '花叶类', '辣椒类', '茄类', '食用菌类', '水生根茎类'};
data1=readtable("销售量.xlsx" );
